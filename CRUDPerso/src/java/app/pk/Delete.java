...
public class Delete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("Delete from personne where id = ?");
            
            ps.setInt(1, id);
            ps.executeUpdate();
            PrintWriter out = response.getWriter();
            //out.print("<h4>Personne supprimer !</h4>");
            
            request.setAttribute("msg", "Personne supprimer avec succes !");
